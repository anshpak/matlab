...
% Задание 3. Разработайте программу (m-сценарий), позволяющую пользователю 
% задавать с помощью мыши два отрезка A и B, после чего отобразите исходный 
% отрезок A, целевой отрезок B и все промежуточные изображения (твины) между 
% A и B при изменении параметра t от 0 до 1 с заданным шагом.
clf
axis([-1 1 -1 1])
